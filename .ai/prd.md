...
1. Generowanie fiszek AI z wklejonego tekstu (limit 1000 - 10000 znaków na jeden zestaw fiszek - kilka/kilkanaście; walidacja front, brak automatycznego przycinania).
...
- Techniczne: web only; Google Gemini jako warstwa modelu AI (np. `gemini-2.5-flash`); priorytet prostoty.
